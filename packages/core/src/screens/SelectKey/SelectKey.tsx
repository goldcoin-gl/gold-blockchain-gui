import type { KeyData } from '@gold-network/api';
import {
  usePrefs,
...
import { GoldBlack, Coins } from '@gold-network/icons';
        ...
        {isLoadingPublicKeys ? (
          ...
          <>
            ...
            <Flex alignItems="center" flexDirection="column">
              ...
              >
                <Trans>Create a new wallet key to get started with Gold.</Trans>
              </Typography>
              <Button
