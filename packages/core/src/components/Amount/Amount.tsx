...
import goldToMojo from '../../utils/goldToMojo';
...
export default function Amount(props: AmountProps) {
  ...
  const isGoldCurrency = ['GL', 'TGL'].includes(currencyCode);
  const mojo = isGoldCurrency ? goldToMojo(correctedValue) : catToMojo(correctedValue);
    ...
    <FormControl variant={variant} fullWidth={fullWidth}>
      <TextField
        ...
        InputProps={{
          ...
          inputProps: {
            decimalScale: isGoldCurrency ? 12 : 3,
            'data-testid': dataTestid,
          },
