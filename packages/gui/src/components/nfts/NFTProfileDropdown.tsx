...
import { useGetDIDsQuery, useGetNFTWallets, useGetNFTWalletsWithDIDsQuery } from '@gold-network/api-react';
import { DropdownActions, MenuItem } from '@gold-network/core';
import { NFTsSmall as NFTsSmallIcon } from '@gold-network/icons';
