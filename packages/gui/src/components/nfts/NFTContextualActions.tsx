...
import { useSetNFTStatusMutation, useLocalStorage } from '@gold-network/api-react';
import { AlertDialog, DropdownActions, MenuItem, useOpenDialog, isValidURL } from '@gold-network/core';
import {
  Burn as BurnIcon,
