import { defaultPlotter, PlotterName } from '@gold-network/api';
import type { Plotter, PlotterMap } from '@gold-network/api';
import { useGetPlottersQuery } from '@gold-network/api-react';
import { CardStep, Select, StateColor } from '@gold-network/core';
...
export default function PlotAddChoosePlotter(props: Props) {
  ...
  function getDisplayablePlotters(p: PlotterMap<PlotterName, Plotter>): PlotterName[] {
    ...
    displayablePlotters.sort((a, b) => (a === PlotterName.GOLDPOS ? -1 : a.localeCompare(b)));
    ...
    <CardStep step={step} title={<Trans>Choose Plotter</Trans>}>
      <Typography variant="subtitle1">
        <Trans>
          ...
          the default Gold Proof of Space plotter. If unsure, use the default Gold Proof of Space plotter.
        </Trans>
      </Typography>
