import { CardStep, ConfirmDialog, Link, Select, StateColor, useOpenDialog } from '@gold-network/core';
    ...
    >
      <Typography variant="subtitle1">
        <Trans>
          ...
          <Link target="_blank" href="https://github.com/goldcoin-gl/gold-blockchain/wiki/k-sizes">
            Learn more
          </Link>
        </Trans>
      </Typography>
