import { defaultPlotter, toBech32m, fromBech32m, WalletCreatePool } from '@gold-network/api';
import { useStartPlottingMutation, useCreateNewPoolWalletMutation } from '@gold-network/api-react';
import { Back, useShowError, ButtonLoading, Flex, Form } from '@gold-network/core';
