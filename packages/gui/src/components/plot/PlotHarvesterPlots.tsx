import { type Plot } from '@gold-network/api';
import { useGetHarvesterPlotsValidQuery, useGetHarvesterQuery } from '@gold-network/api-react';
import { Address, TableControlled, Flex, FormatBytes, Tooltip, StateColor } from '@gold-network/core';
