import { useRefreshPlotsMutation } from '@gold-network/api-react';
import { Button, CardHero, Flex, Link, useOpenDialog } from '@gold-network/core';
import { Plots } from '@gold-network/icons';
      ...
      <Grid xs={12} md={6} lg={5} item>
        <CardHero>
          ...
          <Typography variant="body1">
            <Trans>
              Plots are allocated space on your hard drive used to farm and earn Gold. &nbsp;
              <Link target="_blank" href="https://github.com/goldcoin-gl/gold-blockchain/wiki/Network-Architecture">
                Learn more
              </Link>
            </Trans>
          </Typography>
