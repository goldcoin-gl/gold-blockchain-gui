import { useGetOfferSummaryMutation } from '@gold-network/api-react';
import { Color, Dropzone, Flex, useSerializedNavigationState, useShowError } from '@gold-network/core';
