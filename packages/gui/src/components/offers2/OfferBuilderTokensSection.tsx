...
import { useGetWalletsQuery } from '@gold-network/api-react';
import { Flex, Loading, catToMojo, mojoToCATLocaleString } from '@gold-network/core';
import { Tokens } from '@gold-network/icons';
...
export default function OfferBuilderTokensSection(props: OfferBuilderTokensSectionProps) {
  ...
  return (
    <OfferBuilderSection
      ...
      subtitle={<Trans>Gold Asset Tokens (CATs) are tokens built on top of GL</Trans>}
