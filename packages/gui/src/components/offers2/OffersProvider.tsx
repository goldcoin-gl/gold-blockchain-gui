...
import { useGetOfferSummaryMutation, useCheckOfferValidityMutation } from '@gold-network/api-react';
import { isValidURL } from '@gold-network/core';
...
const log = debug('gold-gui:OfferProvider');
