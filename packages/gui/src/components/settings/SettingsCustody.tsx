...
import { Flex, SettingsHR, SettingsSection, SettingsText } from '@gold-network/core';
...
export default function SettingsCustody() {
  ...
  return (
    <Grid container style={{ maxWidth: '624px' }} gap={3}>
      ...
      <Box>
        <SettingsSection>
          <Trans>Default claw back time for outgoing GL transactions</Trans>
        </SettingsSection>

        <SettingsText>
          <Trans>Set a default time frame for all outbound GL transactions.</Trans>
        </SettingsText>
