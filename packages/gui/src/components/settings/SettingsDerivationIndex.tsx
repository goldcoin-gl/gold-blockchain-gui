import { SyncingStatus } from '@gold-network/api';
import { useExtendDerivationIndexMutation, useGetCurrentDerivationIndexQuery } from '@gold-network/api-react';
import { AlertDialog, ButtonLoading, Flex, Form, TextField, useOpenDialog } from '@gold-network/core';
import { useWalletState } from '@gold-network/wallets';
