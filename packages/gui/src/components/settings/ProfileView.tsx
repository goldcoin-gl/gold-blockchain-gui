...
import { useGetDIDQuery, useGetDIDNameQuery, useSetDIDNameMutation } from '@gold-network/api-react';
import { Color, CopyToClipboard, Flex, Loading, Tooltip, truncateValue } from '@gold-network/core';
