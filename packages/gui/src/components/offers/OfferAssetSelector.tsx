...
import { Select, useCurrencyCode } from '@gold-network/core';
...
type BuildAssetSelectorListParams = {
  ...
  goldCurrencyCode: string;
};

function buildAssetSelectorList(params: BuildAssetSelectorListParams): WalletOfferAssetSelection[] {
  const { wallets, catList, rows, otherRows, selectedWalletId, goldCurrencyCode } = params;
