import { Connection } from '@gold-network/api';
import { useGetFullNodeConnectionsQuery } from '@gold-network/api-react';
import { Card, FormatBytes, FormatLargeNumber, IconButton, Loading, Table, useOpenDialog } from '@gold-network/core';
