import { useGetLatestBlocksQuery, useGetUnfinishedBlockHeadersQuery } from '@gold-network/api-react';
import { FormatLargeNumber, Flex, Card, StateColor, Table, LayoutDashboardSub } from '@gold-network/core';
import { Status } from '@gold-network/icons';
