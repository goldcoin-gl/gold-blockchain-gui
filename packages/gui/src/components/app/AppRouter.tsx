import { SelectKey, LayoutHero, LayoutDashboard, Mode, useMode } from '@gold-network/core';
import { WalletAdd, WalletImport, Wallets, Stake, NFTRecover } from '@gold-network/wallets';
        ...
        <Route path="/" element={<AppProviders outlet />}>
          ...
          {mode === Mode.WALLET ? (
            ...
            >
              ...
              <Route path="dashboard/recover/*" element={<NFTRecover />} />
