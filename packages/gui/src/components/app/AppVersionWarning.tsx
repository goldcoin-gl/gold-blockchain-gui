import { Button, Flex } from '@gold-network/core';
        ...
        <DialogContent>
          <Flex flexDirection="column" gap={1}>
            <Typography variant="body2" color="textSecondary">
              <Trans>
                The Gold application and its services are using different versions. Some functionality may not be behave
                properly as a result.
                <br />
                <br />
                Gold services version: {backV}
                <br />
                Gold application version: {guiV}
                <br />
                <br />
                It is recommended that you quit the Gold application and stop all Gold services.
              </Trans>
            </Typography>
          </Flex>
        </DialogContent>
