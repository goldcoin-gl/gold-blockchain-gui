import type { Connection } from '@gold-network/api';
import { ServiceName } from '@gold-network/api';
import { useGetFarmerFullNodeConnectionsQuery } from '@gold-network/api-react';
import { Table, Card, FormatBytes, FormatConnectionStatus } from '@gold-network/core';
