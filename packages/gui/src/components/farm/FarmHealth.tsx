...
import { Flex, Link, StateIndicator, State, Tooltip, useCurrencyCode } from '@gold-network/core';
      ...
      <Box>
        ...
        <p>
          ...
          <StyledTableForTooltip>
            ...
            <tr>
              <Link target="_blank" href="https://docs.glcoin.net/faq/#why-does-my-gold-farm-say-missing-signage-points">
