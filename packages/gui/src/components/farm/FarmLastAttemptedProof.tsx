import { useGetNewFarmingInfoQuery } from '@gold-network/api-react';
import { Link, Table, Card } from '@gold-network/core';
    ...
    <Card
      ...
      tooltip={
        <Trans>
          ...
          <Link
            target="_blank"
            href="https://github.com/goldcoin-gl/gold-blockchain/wiki/FAQ#what-is-the-plot-filter-and-why-didnt-my-plot-pass-it"
          >
            Learn more
          </Link>
        </Trans>
