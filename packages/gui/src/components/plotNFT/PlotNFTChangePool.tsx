import { useGetPlotNFTsQuery, usePwSelfPoolMutation, usePwJoinPoolMutation } from '@gold-network/api-react';
import { Flex, State, Loading, StateTypography } from '@gold-network/core';
