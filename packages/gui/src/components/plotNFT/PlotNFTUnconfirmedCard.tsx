import type { UnconfirmedPlotNFT } from '@gold-network/api';
import { useGetTransactionQuery } from '@gold-network/api-react';
import { Flex, Link, Loading } from '@gold-network/core';
