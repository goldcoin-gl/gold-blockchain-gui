import type { PlotNFT, PlotNFTExternal } from '@gold-network/api';
import { useGetPoolLoginLinkQuery } from '@gold-network/api-react';
import { Button, CopyToClipboard, Flex, Link, Loading } from '@gold-network/core';
