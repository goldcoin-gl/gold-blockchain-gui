import { useDeleteUnconfirmedTransactionsMutation } from '@gold-network/api-react';
import {
  Button,
  Color,
  TooltipTypography,
...
import { Plot as PlotIcon } from '@gold-network/icons';
...
export default function PlotNFTCard(props: Props) {
  ...
  const rows = [
    ...
    isSelfPooling && {
      ...
      value: <UnitFormat value={mojoToGoldLocaleString(balance)} state={State.SUCCESS} />,
    },
    {
      key: 'plotsCount',
