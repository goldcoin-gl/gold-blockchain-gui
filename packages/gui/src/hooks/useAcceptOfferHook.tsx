import type { OfferSummaryRecord, Wallet } from '@gold-network/api';
import { useTakeOfferMutation } from '@gold-network/api-react';
import { AlertDialog, goldToMojo, useOpenDialog, useShowError } from '@gold-network/core';
...
export default function useAcceptOfferHook(): [AcceptOfferHook] {
  ...
  async function acceptOffer(
    ...
    const feeInMojos: BigNumber = fee ? goldToMojo(fee) : new BigNumber(0);
