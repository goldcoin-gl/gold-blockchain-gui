import api, { store, useGetLoggedInFingerprintQuery } from '@gold-network/api-react';
import { useOpenDialog, useAuth } from '@gold-network/core';
...
const log = debug('gold-gui:walletConnectCommand');
