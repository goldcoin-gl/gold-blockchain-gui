import { useGetWalletBalanceQuery, useGetCurrentDerivationIndexQuery } from '@gold-network/api-react';
import { CardSimple, Flex, TooltipIcon } from '@gold-network/core';
            ...
            <Flex alignItems="center" gap={1}>
              ...
              <TooltipIcon>
                <Trans>
                  ...
                  number is generally higher if you have a lot of transactions or canceled offers for GL, CATs, or
