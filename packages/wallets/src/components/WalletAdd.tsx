import { useGenerateMnemonicMutation, useAddPrivateKeyMutation } from '@gold-network/api-react';
import { ButtonLoading, Form, TextField, Flex, Loading, Logo, useAuth, useShowError } from '@gold-network/core';
