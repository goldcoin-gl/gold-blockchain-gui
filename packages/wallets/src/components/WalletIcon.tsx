import { WalletType, type Wallet } from '@gold-network/api';
import { useGetCatListQuery } from '@gold-network/api-react';
import { Flex, TooltipIcon, useCurrencyCode } from '@gold-network/core';
import { CrCat } from '@gold-network/icons';
