...
import { useSetCATNameMutation, useGetCatListQuery } from '@gold-network/api-react';
import { Flex, Loading, MenuItem, useOpenDialog } from '@gold-network/core';
import { Offers as OffersIcon } from '@gold-network/icons';
