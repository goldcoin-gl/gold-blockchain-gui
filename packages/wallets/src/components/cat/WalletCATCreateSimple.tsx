import type { CATToken } from '@gold-network/api';
import { SyncingStatus } from '@gold-network/api';
import { useGetWalletsQuery, useAddCATTokenMutation, useGetCatListQuery } from '@gold-network/api-react';
import { Back, Flex, Loading, useShowError } from '@gold-network/core';
