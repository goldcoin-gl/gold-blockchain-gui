import { TransactionType } from '@gold-network/api';
import type { Transaction } from '@gold-network/api';
import { useGetAutoClaimQuery, useGetTimestampForHeightQuery, useGetHeightInfoQuery } from '@gold-network/api-react';
import { useTrans, Button } from '@gold-network/core';
