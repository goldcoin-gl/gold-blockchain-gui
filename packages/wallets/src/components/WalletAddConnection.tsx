import { useOpenWalletConnectionMutation } from '@gold-network/api-react';
import { Button, ButtonLoading, DialogActions, Flex, Form, TextField, useShowError } from '@gold-network/core';
...
export default function WalletAddConnection(props: Props) {
  const { onClose, open } = props;
  const [openConnection] = useOpenWalletConnectionMutation();
