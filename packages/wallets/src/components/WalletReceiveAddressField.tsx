import { useGetCurrentAddressQuery, useGetNextAddressMutation } from '@gold-network/api-react';
import { Color, Flex, Loading, truncateValue, useColorModeValue } from '@gold-network/core';
import { Reload } from '@gold-network/icons';
